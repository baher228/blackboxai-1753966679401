        ...
        <div style={footerContentStyles}>
          <div style={contactSectionStyles}>
            <div style={locationStyles}>
              ...
              <p style={contactTextStyles}>alton@fabrikuk.com</p>
            ...
            <div style={locationStyles}>
              ...
              <p style={contactTextStyles}>london@fabrikuk.com</p>
              <p style={addressStyles}>
          ...
          <div style={bottomLinksStyles}>
            ...
            <a href="#" style={footerLinkStyles}>Privacy</a>
            <a href="#" style={footerLinkStyles}>Site by Rabbithole®</a>
          </div>
        </div>
        
        <div style={copyrightStyles}>
          <p>© fabrik, {new Date().getFullYear()}</p>
        </div>
      </div>
    </footer>
  );
