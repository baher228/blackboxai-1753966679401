        ...
        <div style={menuOverlayStyles}>
          <nav style={menuNavStyles}>
            <ul style={menuListStyles}>
              ...
              <li>
                <Link to="/" onClick={() => setIsMenuOpen(false)} style={menuLinkStyles}>
                  viterra
                </Link>
              </li>
              ...
              <li>
                <Link to="/places" onClick={() => setIsMenuOpen(false)} style={menuLinkStyles}>
                  Places
                </Link>
              </li>
              <li>
                <Link to="/services" onClick={() => setIsMenuOpen(false)} style={menuLinkStyles}>
                  Services
                </Link>
              </li>
              <li>
                <Link to="/success" onClick={() => setIsMenuOpen(false)} style={menuLinkStyles}>
                  Success
                </Link>
              </li>
              ...
              <li>
                <Link to="/who-we-are" onClick={() => setIsMenuOpen(false)} style={menuLinkStyles}>
                  Who we are
                </Link>
              </li>
              <li>
                <Link to="/our-team" onClick={() => setIsMenuOpen(false)} style={menuLinkStyles}>
                  Our team
                </Link>
              </li>
              <li>
                <Link to="/join-us" onClick={() => setIsMenuOpen(false)} style={menuLinkStyles}>
                  Join us
                </Link>
              </li>
              <li>
                <Link to="/get-in-touch" onClick={() => setIsMenuOpen(false)} style={menuLinkStyles}>
                  Get in touch
                </Link>
              </li>
              ...
              <li>
                <Link to="/our-values" onClick={() => setIsMenuOpen(false)} style={menuLinkStyles}>
                  Our values
                </Link>
              </li>
              <li>
                <Link to="/common-ground" onClick={() => setIsMenuOpen(false)} style={menuLinkStyles}>
                  Common ground
                </Link>
              </li>
            </ul>
